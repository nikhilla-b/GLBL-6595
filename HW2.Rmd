...
## Question 4d: -----
What the results show us is that companies that reported a major problem of working capital shortage had higher vmpk??????????? that makes no sense

SO I guess it means the more productive firms are capital constrained
```{r}
...
# results
modelsummary(capital_notsolve_lm,
             gof_map = "nobs",
