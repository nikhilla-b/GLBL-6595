...
## Question 4d: -----
The results show us that firms that experienced working capital shortage had, on average, 28.3% higher VMPK than firms that did not experience such shortage. This does make sense: we have seen that smaller firms have higher values of VMPK and so this higher VMPK could be because they lack access to sufficient capitql and experience capital crunches.So, possibly if smaller firms had better access to capital they could grow more and add more capital (which would decrease their VMPK).
```{r}
